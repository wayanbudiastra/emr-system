  ...
  if (!dokter) {
    return (
      <div className="text-center py-16">
        ...
        <Link href="/pengaturan/data-dokter" className={cn(buttonVariants({ variant: 'outline' }), 'mt-4')}>
          Kembali
        </Link>
      </div>
    );
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        <Link href="/pengaturan/data-dokter" className={cn(buttonVariants({ variant: 'ghost', size: 'icon' }))}>
